...
function initRuntimeSocketService() {
  const hosts = "192.168.50.185,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_pk5wM4";
...
const S = true, b = "mp-weixin", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.50.185"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/Direct-Software/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"tencent","spaceName":"study-sherry","spaceId":"tcb-x5erb7ey2zr847h-3cmkd3885b8f"}]') || [];
let O = "";
try {
  O = "__UNI__3319D8C";
} catch (e2) {
